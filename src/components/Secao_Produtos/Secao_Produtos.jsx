...
function Secao_Produtos() {
    ...
    const data = [
        {id: 1, image: gasolinaGRID, title:'GASOLINA PETROBRAS GRID', subtitle:'A ESCOLHA INTELIGENTE', text:'Com a nova tecnologia de aditivação TECNO 3 a GRID evita a formação de sujeira e deixa o motor cada vez mais limpo e protegido, evitando desgaste e corrosão e melhora o funcionamento do motor, trazendo mais economia!'},
